  ...
  function HTMLVimeoVideoElement( id ) {
    ...
    var self = this,
      ...
      impl = {
        ...
        ended: false,
        paused: true,
        width: parseInt(parent.style.width)|0   ? parseInt(parent.style.width)  : MIN_WIDTH, // Modif FR
        height: parseInt(parent.style.height)|0 ? parseInt(parent.style.height) : MIN_HEIGHT, // Modif FR
        error: null
      },
      playerReady = false,
