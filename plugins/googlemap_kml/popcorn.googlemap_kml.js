...
(function ( Popcorn ) {
  ...
  function buildMap( options, location, mapDiv ) {
    ...
    if (options.kml) {
    	var ctaLayer = new google.maps.KmlLayer(options.kml);
		ctaLayer.setMap(map);
    }
   ...
   *
   */
  Popcorn.plugin( "googlemap_kml", function ( options ) {
    ...
    about: {
      name: "Popcorn Google Map Kml Plugin",
      version: "0.1",
      author: "Franck RONDOT",
      website: "www.franck-rondot.com"
    },
    options: {
      start: {
        elem: "input",
